...
class Subtitles extends Model
{
    ...
    {
        $subtitle = "INSERT INTO tb_curse_subtitle(subtitle_number, subtitle, subtitle_description, ID_CURSE, ID_SUBJECT) VALUES(:subtitle_number, :subtitle, :subtitle_description, :id_curse, :id_subject)";
        $stmt = $this->db->prepare($subtitle);
